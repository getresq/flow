...
const sheetVariants = cva(
  'fixed z-50 flex flex-col gap-4 border border-[var(--border-default)] bg-[var(--surface-raised)] p-4 text-[var(--text-primary)] shadow-xl transition-transform duration-200 ease-out',
  {
    variants: {
      side: {
